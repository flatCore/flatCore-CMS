...
$cols = array(
  ...
  "user_groups" => "VARCHAR(20) NOT NULL DEFAULT ''",
  "user_avatar" => "VARCHAR(20) NOT NULL DEFAULT ''",
  ...
  "user_registerdate" => "VARCHAR(50) NOT NULL DEFAULT ''",
  "user_verified" => "VARCHAR(20) NOT NULL DEFAULT ''",
  "user_drm" => "VARCHAR(50) NOT NULL DEFAULT ''",
  ...
  "user_street" => "VARCHAR(20) NOT NULL DEFAULT ''",
