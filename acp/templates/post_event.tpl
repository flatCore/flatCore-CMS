	...
	<div class="row">
		<div class="col-md-9">
			...
			<ul class="nav nav-tabs card-header-tabs" id="bsTabs" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#info">{post_tab_info}</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#prices">{post_tab_prices}</a></li>
