...
echo '<li class="nav-item"><a class="nav-link active" href="#" data-bs-target="#log" data-bs-toggle="tab">'.$icon['file'].' Logfile</a></li>';
echo '<li class="nav-item"><a class="nav-link" href="#" data-bs-target="#sitemap" data-bs-toggle="tab">'.$icon['sitemap'].' sitemap.xml</a></li>';
echo '<li class="nav-item"><a class="nav-link" href="#" data-bs-target="#deleted_resources" data-bs-toggle="tab">'.$icon['trash'].' '.$lang['label_deleted_resources'].'</a></li>';
echo '<li class="nav-item"><a class="nav-link" href="#" data-bs-target="#config" data-bs-toggle="tab">'.$icon['gear'].' Config</a></li>';
echo '</ul>';
