...
echo '<li><a class="sidebar-sub" href="acp.php?tn=pages&sub=rss">'.$icon['rss'].' RSS</a></li>';
...
echo '<li><a class="sidebar-sub" data-toggle="modal" data-target="#uploadModal" href="#">'.$icon['upload'].' '.$lang['go_to_upload'].'</a></li>';
