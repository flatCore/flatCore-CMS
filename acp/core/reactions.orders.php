...
if(is_numeric($_POST['open_order'])) {
	...
	$order_form_tpl = str_replace('{form_action}', "?tn=reactions&sub=orders", $order_form_tpl);
...
for($i=0;$i<$cnt_orders;$i++) {
	...
	$select_status_order  = '<form action="?tn=reactions&sub=orders" method="POST">';
	...
	$select_status_payment  = '<form action="?tn=reactions&sub=orders" method="POST">';
	...
	$select_status_shipping  = '<form action="?tn=reactions&sub=orders" method="POST">';
	$select_status_shipping .= '<select name="change_status_shipping" class="form-control">';
	...
	$btn_open_order  = '<form action="?tn=reactions&sub=orders" method="POST">';
