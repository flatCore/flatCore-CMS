...
echo '<a class="'.$active[8].'" href="acp.php?tn=shop" title="'.$lang['tn_shop_desc'].'"><span class="top-nav-icon">'.$icon['store'].'</span><span class="top-nav-text">'.$lang['tn_shop'].'</span></a>';
echo '<a class="'.$active[9].'" href="acp.php?tn=events" title="'.$lang['tn_events_desc'].'"><span class="top-nav-icon">'.$icon['calendar_event'].'</span><span class="top-nav-text">'.$lang['tn_events'].'</span></a>';
